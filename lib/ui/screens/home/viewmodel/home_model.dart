...
class HomeViewModel extends ChangeNotifier{
  ...
  RidePreference? get selectedPreference => ridePreferenceState.currentRidePreference;
  List<RidePreference> get history => ridePreferenceState.ridePreferenceHistory;
  ...
  Future<void> onRidePrefSelected(RidePreference preference) async {
    ridePreferenceState.selectRidePreference(preference);
